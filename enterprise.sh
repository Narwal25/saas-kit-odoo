...
update_odoo_version_files() {
    ...
    sed -i 's/.*SAAS_ODOO_VERSIONS.*/SAAS_ODOO_VERSIONS = ["16.0","17.0","18.0","16e.0","17e.0","18e.0"]/' $static_custom_plan_path
    sed -i 's/.*SAAS_ODOO_VERSIONS.*/SAAS_ODOO_VERSIONS = ["16.0","17.0","18.0","16e.0","17e.0","18e.0"]/' $static_saas_kit_path
}
...
saas_conf_paths_update_enterprise() {
    ...
    
    {
        ...
        echo ""
        echo "odoo_template_v18e = odoo18e_template_cont"
        echo "common_addons_v18e = ${odoo_saas_custom_path}common-addons_v18e"
        echo "template_odoo_port_v18e = 8838"
        echo "template_odoo_lport_v18e = 8848"
    } > ${saas_conf_path}
